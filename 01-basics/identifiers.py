...
x = 0
#global = 1 - identifikátor nesmí obsahovat klíčová slova
globalní = 1
PI = 3.14
city = "Opava"
#hilda@sspu-opava.cz = 'Hilda Dokonalá' - identifikátor nesmí obsahovat některé speciální znaky např. [!@#$%]
hildasspu_opavacz = 'Hild Dokonalá'
password2 = 'TajneHeslo'
#007agent = 'James Bond' - identifikátor nemůže začínat čísly
agent007 = 'James Bond'
